...
#include "Implementation/Repository.h"
#include <iostream>
#include <fstream>
#include <list>
#include <conio.h>
...
//main for test template class Repository:
int main() {
    Person person_1 = Person("Ivan Laska", "2112", "man", 21);
    Repository<Person,Ticket>  client_1 =  Repository<Person,Ticket> (person_1,120);
    Repository<Person,Ticket>  client_2 =  Repository<Person,Ticket> (person_1,220);
    cout << "----------------------------------" <<endl;
    cout << "Try to compare 2 template client" <<endl;
    cout << "Template client 1" <<endl;
    cout << client_1.ToString() <<endl;
    cout << "----------------------------------" <<endl;
    cout << "Template client 2" <<endl;
    cout << client_2.ToString() <<endl;
    cout << "----------------------------------" <<endl;
    if(!(client_1 == client_2))
    {
        cout << "Template client not equal" <<endl;
    }
    else
    {
        cout << " Template client equal" <<endl;
    }
}
